...
2. Run `npm install` to grab the dependencies (basically just Express, Cors, Dotenv, and the Google Gen-AI SDK).
...
*Note: If you want to test the AR camera features, you might need to run it over HTTPS (or localhost) depending on your browser's security policies regarding camera access.*
